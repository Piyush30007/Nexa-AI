...
import uuid
import json
from backend.app.ingestion.Loader.pdf_loader import parse_pdf
import logfire
...
#ingest only clean data python -m app.ingestion.processorr DATA/true_data true 
    ...
    with logfire.span("Processing File", file=filename, source=source_type):
        try:
            ...
            if ext == "pdf":
                ...
                from app.ingestion.Loader.pptx_loader import parse_office
